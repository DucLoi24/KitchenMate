...
This project is indexed by GitNexus as **KitchenMate** (4102 symbols, 6734 relationships, 70 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
