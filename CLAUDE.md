...
This project is indexed by GitNexus as **KitchenMate** (1879 symbols, 3414 relationships, 73 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
