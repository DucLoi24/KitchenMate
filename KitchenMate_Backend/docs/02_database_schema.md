...
Database sử dụng **PostgreSQL**. Có tổng cộng **8 bảng chính** được phân bổ trong 5 Django apps.
...
### 4. `recipe_ingredients` — Nguyên liệu trong công thức
...
### 5. `recipe_steps` — Các bước thực hiện
...
### 7. `shopping_lists` — Danh sách đi chợ
...
### 10. `collection_recipes` — Công thức trong bộ sưu tập
